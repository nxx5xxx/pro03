		...
		<table class="table">
			<tbody>
				...
				<tr>
					...
					<input type="text" name="postcode" id="postcode" placeholder="우편번호" class="input" value="${fn:substring(food.addr, 1, 6 )}" readonly>
				...
				<tr>
					...
					<td>
						<input type="hidden" name="file1" id="file1" value="${food.file1 }">
